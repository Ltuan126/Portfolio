...
const translations = {
  ...
  vi: {
    ...
    skillNotes: ['Stack chính', 'Logic API', 'Giải quyết vấn đề', 'Trâu bò thị giác', 'Code đáng tin cậy', 'ưu trữ dữ liệu'],
    skillTitles: ['React', 'Node.js', 'Python', 'Tailwind CSS', 'TypeScript', 'MongoDB'],
    skillDescriptions: [
    ...
    softSkillTitles: ['Giải quyết vấn đề', 'Đàn đôn nhóm', 'Giao tiếp', 'Quản lý dự án', 'Hướng dẫn', 'Tư duy sáng tạo', 'Thích nghi', 'Quản lý thời gian'],
    softSkillDesc: [
      'Phân tích vấn đề và đưa ra cách xử lý thực tế.',
      'Giữ công việc rõ ràng, đồng bộ và đúng hướng.',
      'Trình bày ý tưởng rõ ràng cho cả đội kỹ thuật và phi kỹ thuật.',
      'Tổ chức nhiệm vụ, tiến độ và ưu tiên gọn gàng.',
      'Chia sẻ kiến thức để người khác phát triển.',
      'ìm cách làm gọn hơn và dễ dùng hơn.',
      'Điều chỉnh nhanh khi yêu cầu hoặc công cụ thay đổi.',
      'Đảm bảo tiến độ mà vẫn giữ chất lượng.'
    ],
    ...
    certificateDesc: 'Nội dung chung chỉ sẽ được bổ sung theo các mốc phát triển mới.',
